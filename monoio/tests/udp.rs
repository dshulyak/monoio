...
mod multishot_tests {
    ...
    use monoio::{
        buf::{
            AnyRecvMsgParser, Ipv4RecvMsgParser, Ipv6RecvMsgParser, MmapedRecvMsgRingBuf,
            MmapedRingBufBuilder, RecvMsgParser,
        },
        io::Canceller,
    ...
    async fn test_recvmsg_multishot<P>(
        recv: &mut RecvMsgMultishot<MmapedRecvMsgRingBuf<P>>,
        sender: &UdpSocket,
    ...
    async fn recvmsg_ipv4() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(16, PAYLOAD_SIZE, 0).unwrap();
    ...
    async fn recvmsg_ipv6() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv6RecvMsgParser>::new(16, PAYLOAD_SIZE, 1).unwrap();
        let canceller = Canceller::new();
        let mut stream = receiver
            .cancelable_recvmsg_multishot(ring, canceller.handle())
            .unwrap();
    ...
    async fn recvmsg_any() {
        ...
        let ring = MmapedRecvMsgRingBuf::<AnyRecvMsgParser>::new(16, PAYLOAD_SIZE, 2).unwrap();
        let canceller = Canceller::new();
        let mut stream = receiver
            .cancelable_recvmsg_multishot(ring, canceller.handle())
            .unwrap();
    ...
    async fn recvmsg_multishot_buffer_reuse() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(4, 64, 30).unwrap();
        let canceller = Canceller::new();
        let mut stream = receiver
            .cancelable_recvmsg_multishot(ring, canceller.handle())
            .unwrap();
    ...
    async fn recvmsg_multishot_buffer_exhaustion_and_recovery() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(4, 64, 60).unwrap();
    ...
    async fn recvmsg_multishot_multiple_senders() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(16, PAYLOAD_SIZE, 40).unwrap();
        let canceller = Canceller::new();
        let mut stream = receiver
            .cancelable_recvmsg_multishot(ring, canceller.handle())
            .unwrap();
    ...
    async fn recvmsg_multishot_sequential_messages() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(32, 64, 50).unwrap();
        let canceller = Canceller::new();
        let mut stream = receiver
            .cancelable_recvmsg_multishot(ring, canceller.handle())
            .unwrap();
    ...
    async fn recv_multishot_cancel() {
        ...
        let ring = MmapedRingBufBuilder::new()
    ...
    async fn recvmsg_multishot_cancel() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(16, PAYLOAD_SIZE, 50).unwrap();
    ...
    #[monoio::test(driver = "uring")]
    #[should_panic(expected = "MmapedRingBuf dropped without calling unregister()")]
    async fn ringbuf_panics_on_drop_without_unregister() {
        let _ring = MmapedRingBufBuilder::new()
            .buffer_size(64)
            .buffer_count(4)
            .group_id(99)
            .build()
    ...
    async fn buffer_ring_held_buffers_not_overwritten() {
        ...
        let ring = MmapedRecvMsgRingBuf::<Ipv4RecvMsgParser>::new(4, 64, 70).unwrap();
        let canceller = Canceller::new();
        let mut stream = receiver
            .cancelable_recvmsg_multishot(ring, canceller.handle())
            .unwrap();
